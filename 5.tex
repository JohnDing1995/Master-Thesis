...
\begin{table}[h!]
    \begin{center}
        ...
        Build Time &
          \begin{tabular}[c]{@{}l@{}}98s for a singe task.\\ Largely increases when\\ run multiple tasks in \\ parallel\end{tabular} &
...
\par
In general, the AWS integrated toolchain is more expensive and more slower than my Jenkins-centred non-integrated toolchain, note that this does not means the non-integrated is better. As we discussed in last chapter, the AWS integrated toolchain is easier and faster to implement, is more stable and with better costumer support. The Table \ref{tab:exp2} shows the result of this experiment.
\begin{table}[]
    \centering
    \begin{tabular}{|l|l|l|}
    \hline
