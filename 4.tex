...
\par
% Nevertheless, in real-life development, many projects are in microservices architecture, rather than homogeneous architecture as I have in the case project. Microservices architecture means the project composed of multiple different services which running in different VM or Docker instance. Thus different services could have very different metrics such as CPU utilization. 
