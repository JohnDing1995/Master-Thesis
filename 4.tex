...
\begin{figure}[h]
 ...
 \label{fig:overview}
\end{figure}
Figure \ref{fig:overview} shows the five Jenkins stages in our pipeline. The bottom part of this Figure shows the task distribution between the master node and agent nodes. The master node is an EC2 virtual machine while agents run on Fargate instances within an ECS cluster.
\par
